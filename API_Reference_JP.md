...
<!-- IMAGE: api_play_transition_node.png - Play Transition And Wait Latent Action ノードの Blueprint スクリーンショット -->
...
<!-- IMAGE: api_open_level_node.png - Open Level With Transition ノードの Blueprint スクリーンショット -->
...
<!-- IMAGE: api_quick_fade_node.png - Quick Fade To Black / Quick Fade From Black ノードの Blueprint スクリーンショット -->
...
<!-- IMAGE: api_preload_node.png - Preload Transition Presets ノードの Blueprint スクリーンショット -->
